 ...
 */
package com.ariesninja.skulkpk.client.utils.movement
...
import com.ariesninja.skulkpk.client.utils.client.toDegrees
...
private fun collectCollisionBoundingBoxes(
    ...
    for (pos in BlockPos.iterate(fromBlockPos, toBlockPos)) {

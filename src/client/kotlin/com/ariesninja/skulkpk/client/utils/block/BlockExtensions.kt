...
package com.ariesninja.skulkpk.client.utils.block
...
import com.ariesninja.skulkpk.client.event.events.BlockBreakingProgressEvent
...
//
//        if (filter(it, state)) {
//            SequenceScope.yield(Pair(it.toImmutable(), state))
//        }
//    }
//}
...
//
//            if (layer > 0) {
//                SequenceScope.yield(IntObjectPair.of(layer, BlockPos.fromLong(pos)))
//            }
//
//            if (layer >= layers) {
//                continue
...
//            SequenceScope.yield(DoubleObjectPair.of(distanceSq, it.toImmutable()))
//        }
//    }
//}
...
//    }
//
//    return getBlock() contains FALL_DAMAGE_BLOCKING_BLOCKS
//}
...
//        if (it.boundingBox.intersects(posBox) && (excludeIds == null || it.id contains excludeIds)) {

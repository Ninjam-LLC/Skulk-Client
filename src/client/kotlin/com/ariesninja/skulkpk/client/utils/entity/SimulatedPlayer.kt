...
import com.ariesninja.skulkpk.client.event.EventManager.callEvent
import com.ariesninja.skulkpk.client.event.events.PlayerMoveEvent
import com.ariesninja.skulkpk.client.event.events.PlayerSafeWalkEvent
import com.ariesninja.skulkpk.client.utils.block.getBlock
...
import com.ariesninja.skulkpk.client.utils.math.toBlockPos
import com.ariesninja.skulkpk.client.utils.movement.DirectionalInput
import com.ariesninja.skulkpk.client.utils.movement.getDegreesRelativeToView
import com.ariesninja.skulkpk.client.utils.movement.getDirectionalInputForDegrees
    ...
    companion object {
        fun fromClientPlayer(input: SimulatedPlayerInput): SimulatedPlayer {
            return SimulatedPlayer(
                ...
                kotlin.collections.HashSet(player.submergedFluidTag)
            )
        }
...
//            }
    ...
    fun clone(): SimulatedPlayer {
        return SimulatedPlayer(
            ...
            kotlin.collections.HashSet(submergedFluidTag)
        )
    }
